    ...
    def dag_factory(_default_args : dict, _api_admin_dvos : List[ApiAdminDvo]) -> List[DAG]:
        ...
        for api_admin_dvo in _api_admin_dvos:
            ...
            if(dvo.src_nm == DATACOLLECTIONSOURCENAME.KOSIS.value):
                ...
                dag_param_dto.uri = kosis_url_obj.get_full_url()
                ...
                weatheradministration_open_api_dag : WeatherAdministrationOpenApiDag = WeatherAdministrationOpenApiDag.create_weatheradministration_open_api_dag(dag_config_param=dag_param_dto.to_dict(),
                                                                                                                                                                 dag_id = dag_param_dto.remove_except_alphanumericcharacter_dashe_dot_underscore(f'{dag_param_dto.tb_code}_WeatherAdministration_WeatherStatics'),
                ...
                if(dvo.tb_nm == PublicDataPortalTableName.SOLARTERM.value):
                    dag_param_dto = DagParamDto(src_nm = dvo.src_nm,
                                    tb_code = dvo.tb_code,
                                    tb_nm = dvo.tb_nm,
                                    uri = dvo.uri,
                                    dir_path = dvo.dir_path,
                                    api_keys = ["%2BODpMm%2FIQ2XvsE4H4adLL5A5Oc7bExWMxoT1AlGn8Up%2BAzzvEQ4zxh7WhZK6Z278Of4pxFE%2Bp4Zh7XqZHTFctA%3D%3D"])
                    publicdataportal_solarterm_dag = PublicDataPortalSolarTermDag.create_publicdataportal_solarterm_dag(dag_config_param=dag_param_dto.to_dict(),
                                                                                                                     dag_id=dag_param_dto.remove_except_alphanumericcharacter_dashe_dot_underscore(f'{dag_param_dto.tb_code}_PublicDataPortal_SolarTerm'),
                    ...
                    dag_param_dto = DagParamDto(src_nm = dvo.src_nm,
                                    ...
                                    dir_path = dvo.dir_path,
                                    api_keys = ["%2BODpMm%2FIQ2XvsE4H4adLL5A5Oc7bExWMxoT1AlGn8Up%2BAzzvEQ4zxh7WhZK6Z278Of4pxFE%2Bp4Zh7XqZHTFctA%3D%3D"])
                    publicdataportal_holiday_dag = PublicDataPortalHolidayDag.create_publicdataportal_holiday_dag(dag_config_param=dag_param_dto.to_dict(),
                                                                                                                 dag_id=dag_param_dto.remove_except_alphanumericcharacter_dashe_dot_underscore(f'{dag_param_dto.tb_code}_PublicDataPortal_Holiday'),
                                                                                                                 schedule_interval=timedelta(months=1),
                                                                                                                 start_date=datetime(2015, 1, 1),
                                                                                                                 default_args=_default_args)
                    ...
                    dag_param_dto = DagParamDto(src_nm = dvo.src_nm,
                                    ...
                                    dir_path = dvo.dir_path,
                                    api_keys = ["%2BODpMm%2FIQ2XvsE4H4adLL5A5Oc7bExWMxoT1AlGn8Up%2BAzzvEQ4zxh7WhZK6Z278Of4pxFE%2Bp4Zh7XqZHTFctA%3D%3D"])
                    publicdataportal_nationalday_dag = PublicDataPortalNationalDayDag.create_publicdataportal_nationalday_dag(dag_config_param=dag_param_dto.to_dict(),
                                                                                                                     dag_id=dag_param_dto.remove_except_alphanumericcharacter_dashe_dot_underscore(f'{dag_param_dto.tb_code}_PublicDataPortal_NationalDay'),
                                                                                                                     schedule_interval=timedelta(months=1),
                                                                                                                     start_date=datetime(2015, 1, 1),
                                                                                                                     default_args=_default_args)
                    ...
                    dag_param_dto = DagParamDto(src_nm = dvo.src_nm,
                                    ...
                                    dir_path = dvo.dir_path,
                                    api_keys = ["%2BODpMm%2FIQ2XvsE4H4adLL5A5Oc7bExWMxoT1AlGn8Up%2BAzzvEQ4zxh7WhZK6Z278Of4pxFE%2Bp4Zh7XqZHTFctA%3D%3D"])
                    publicdataportal_anniversary_dag = PublicDataPortalAnniversaryDag.create_publicdataportal_anniversary_dag(dag_config_param=dag_param_dto.to_dict(),
                                                                                                                     dag_id=dag_param_dto.remove_except_alphanumericcharacter_dashe_dot_underscore(f'{dag_param_dto.tb_code}_PublicDataPortal_Anniversary'),
                                                                                                                     schedule_interval=timedelta(months=1),
                                                                                                                     start_date=datetime(2015, 1, 1),
                                                                                                                     default_args=_default_args)
                    ...
                    dag_param_dto = DagParamDto(src_nm = dvo.src_nm,
                                    ...
                                    dir_path = dvo.dir_path,
                                    api_keys = ["%2BODpMm%2FIQ2XvsE4H4adLL5A5Oc7bExWMxoT1AlGn8Up%2BAzzvEQ4zxh7WhZK6Z278Of4pxFE%2Bp4Zh7XqZHTFctA%3D%3D"])
                    publicdataportal_traditionalday_dag = PublicDataPortalTraditionalDayDag.create_publicdataportal_traditionalday_dag(dag_config_param=dag_param_dto.to_dict(),
                                                                                                                     dag_id=dag_param_dto.remove_except_alphanumericcharacter_dashe_dot_underscore(f'{dag_param_dto.tb_code}_PublicDataPortal_TraditionalDay'),
                                                                                                                     schedule_interval=timedelta(months=1),
                                                                                                                     start_date=datetime(2015, 1, 1),
                                                                                                                     default_args=_default_args)
