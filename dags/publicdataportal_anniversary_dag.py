    ...
    def create_publicdataportal_anniversary_dag(dag_config_param : dict, dag_id : str, schedule_interval : timedelta, start_date : datetime, default_args : dict) -> DAG:
        ...
        def publicdataportal_anniversary_dag() -> DAG:
            ...
            def open_api_request():
                ...
                request_url = None
                publicdataportal_anniversary_url_obj : PublicDataPortalAnniversaryUrl = None
                if prev_task_instance is None:
                    request_url = dag_config_param['uri']
                    assert request_url is not None
                    publicdataportal_anniversary_url_obj : PublicDataPortalAnniversaryUrl = UrlObjectFactory.createPublicDataPortalAnniversaryUrl(request_url)
                ...
                request_url_obj : PublicDataPortalAnniversaryUrl = UrlObjectFactory.createPublicDataPortalAnniversaryUrl(request_url)
                next_request_url_obj : PublicDataPortalAnniversaryUrl = UrlObjectFactory.createPublicDataPortalAnniversaryUrl(request_url)
